...
\noindent\hspace*{\centeroffset}
\begin{center}
    {\includegraphics[width=6cm]{include/logos-valgrai/escudo-valenciano.eps}}\\[0.5cm]
    {\includegraphics[width=6cm]{include/logos-valgrai/valgrai-logo.eps}}\\[1.0cm]
\end{center}
%\begin{minipage}[l]{6cm}
%\includegraphics[width=5cm]{include/logos-valgrai/escudo-valenciano.eps}
%\end{minipage}
%\begin{minipage}[r]{6cm}
%\includegraphics[width=5cm]{include/logos-valgrai/valgrai-logo.eps}
%\end{minipage}
%\\[0.5cm]
\begin{minipage}[l]{6cm}
