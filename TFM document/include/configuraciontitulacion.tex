...
\definecolor{ia}{RGB}{201,33,30} %IA
...
% Másteres
	...
	\else \if\IDtitulo L % Ciberseguridad
		...
		\newcommand{\colortexto}{blanco}
        \else \if\IDtitulo Z % IA
		% Logos
		\newcommand{\logoFacultadPortada}{include/logos-universidad/LogoEPSBlanco}
		\newcommand{\logoGradoPortada}{include/logos-titulaciones/ia}
		\newcommand{\logoGrado}{include/logos-titulaciones/ia-negro}
		% Texto
		\newcommand{\miGrado}{Máster en Inteligencia Artificial}
		\newcommand{\tipotrabajo}{Trabajo Fin de Máster}
		% Color
		\newcommand{\colorgrado}{ia}
		\newcommand{\colortexto}{blanco}
        %LogoMasterIABlanco
